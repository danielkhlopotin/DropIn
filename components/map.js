...
/*
<Marker coordinate={{latitude: 39.706293, longitude: -105.127816}} image={require('../DropIn-Icons-And-Files/tennis.png')} anchor={{x: 0.5, y: 0.5}}>
  <Callout>
    <View style={styles.callout}>
      <Text style={styles.calloutText}>South Simms Street Park</Text>
      <Text style={styles.calloutText}>Tennis - 7PM </Text>
      <Text style={styles.calloutText}>More text</Text>
    </View>
  </Callout>
</Marker>
<Marker coordinate={{latitude: 39.670337, longitude: -105.162347}} image={require('../DropIn-Icons-And-Files/baseball.png')} anchor={{x: 0.5, y: 0.5}}>

  <Callout>
    <View style={styles.callout}>
      <Text style={styles.calloutText}>Coyote Gulch Park</Text>
      <Text style={styles.calloutText}>Baseball - 6PM </Text>
      <Text style={styles.calloutText}>More text</Text>
    </View>
  </Callout>
</Marker>
<Marker coordinate={{latitude: 39.687828, longitude: -105.129200}} image={require('../DropIn-Icons-And-Files/frisbee.png')} anchor={{x: 0.5, y: 0.5}}>
  <Callout>
    <View style={styles.callout}>
      <Text style={styles.calloutText}>Jackson Park</Text>
      <Text style={styles.calloutText}>Ultimate Frisbee - 4PM </Text>
      <Text style={styles.calloutText}>More text</Text>
    </View>
  </Callout>
</Marker>
<Marker coordinate={{latitude: 39.695417, longitude: -105.143418}} image={require('../DropIn-Icons-And-Files/soccer.png')} anchor={{x: 0.5, y: 0.5}}>
  <Callout>
    <View style={styles.callout}>
      <Text style={styles.calloutText}>Green Mountain High School</Text>
      <Text style={styles.calloutText}>Soccer - 12PM </Text>
      <Text style={styles.calloutText}>More text</Text>
    </View>
  </Callout>
</Marker>
<Marker coordinate={{latitude: 39.718476, longitude: -105.136605}} image={require('../DropIn-Icons-And-Files/volleyballAlt.png')} anchor={{x: 0.5, y: 0.5}}>
  <Callout>
    <View style={styles.callout}>
      <Text style={styles.calloutText}>Union Square Park</Text>
      <Text style={styles.calloutText}>Volleyball - 2PM </Text>
      <Text style={styles.calloutText}>More text</Text>
    </View>
  </Callout>
</Marker>
<Marker coordinate={{latitude: 39.719456, longitude: -105.118715}} image={require('../DropIn-Icons-And-Files/football.png')} anchor={{x: 0.5, y: 0.5}}>
  <Callout>
    <View style={styles.callout}>
      <Text style={styles.calloutText}>Random Place</Text>
      <Text style={styles.calloutText}>Volleyball - 2PM </Text>
      <Text style={styles.calloutText}>More text</Text>
    </View>
  </Callout>
